...
namespace HealthPlan.Tests.Integration
{
    /// <summary>
    ...
    public class QuoteModelingExamplesTests
    {
        ...
        public void DomainModels_ShouldSupportSQLRelationships()
        {
            ...
            var healthPlan = new HealthPlan.Domain.Entities.HealthPlan 
            { 
                Id = 1, 
            ...
            var quote = new HealthPlan.Domain.Entities.Quote
            {
                Id = 1,
                CompanyId = company.Id,
                Company = company,
        ...
        private static List<HealthPlan.Domain.Entities.HealthPlan> CreateTestHealthPlans(List<Company> companies, List<Accommodation> accommodations)
        {
            return new List<HealthPlan.Domain.Entities.HealthPlan>
            {
        ...
        private static List<HealthPlan.Domain.Entities.Quote> CreateTestQuotes(List<Company> companies, List<Beneficiary> beneficiaries, 
            List<HealthPlan.Domain.Entities.HealthPlan> healthPlans, List<AgeRange> ageRanges)
        {
            return new List<HealthPlan.Domain.Entities.Quote>
            {
