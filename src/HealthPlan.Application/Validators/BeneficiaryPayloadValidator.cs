...
{
    /// <summary>
    /// Validator for BeneficiaryPayLoadDTO.
    /// Defines validation rules for beneficiary payload data.
    /// </summary>
    public class BeneficiaryPayloadValidator : AbstractValidator<BeneficiaryPayLoadDTO>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BeneficiaryPayloadValidator"/> class.
        /// </summary>
        public BeneficiaryPayloadValidator()
        {
            RuleFor(x => x.Name)
                .NotEmpty()
