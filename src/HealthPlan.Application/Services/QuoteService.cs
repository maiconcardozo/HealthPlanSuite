...
namespace HealthPlan.Application.Services
{
    ...
    public class QuoteService : IQuoteService
    {
        ...
        public IEnumerable<Domain.Entities.Quote> GetAllQuotes()
        {
        ...
        public Domain.Entities.Quote? GetQuoteByNumber(string quoteNumber)
        {
        ...
        /// <returns>Quote if found, null otherwise</returns>
        public Domain.Entities.Quote? GetById(int id)
        {
        ...
        public IEnumerable<Domain.Entities.Quote> GetQuotesByIds(IEnumerable<int> quoteIds)
        {
            var result = new List<Domain.Entities.Quote>();
        ...
        public IEnumerable<Domain.Entities.Quote> GetQuotesByBeneficiary(int beneficiaryId)
        {
        ...
        public IEnumerable<Domain.Entities.Quote> GetQuotesByCompany(int companyId)
        {
        ...
        /// <returns>Collection of matching quote entities</returns>
        public IEnumerable<Domain.Entities.Quote> GetQuotes(Expression<Func<Domain.Entities.Quote, bool>> predicate)
        {
        ...
        public Domain.Entities.Quote? GetSingleOrDefaultQuote(Expression<Func<Domain.Entities.Quote, bool>> predicate)
        {
        ...
        public IEnumerable<Domain.Entities.Quote> GetAllActiveQuotes()
        {
            return _quoteRepository.GetAll().Where(q => q.IsActive);
        }
        ...
        public IEnumerable<Domain.Entities.Quote> GetAllPendingQuotes()
        {
        ...
        public void AddQuote(Domain.Entities.Quote quote)
        {
        ...
        public void AddQuotes(IEnumerable<Domain.Entities.Quote> quotes)
        {
        ...
        public void UpdateQuote(Domain.Entities.Quote quote)
        {
        ...
        public void DeleteQuote(Domain.Entities.Quote quote)
        {
        ...
        public void DeleteQuotes(IEnumerable<Domain.Entities.Quote> quotes)
        {
            foreach (var quote in quotes)
            {
                _quoteRepository.Remove(quote);
