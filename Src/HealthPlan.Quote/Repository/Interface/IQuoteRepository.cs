...
namespace HealthPlan.Quote.Repository.Interface
{
    ...
    /// </summary>
    public interface IQuoteRepository : IEntityRepository<Domain.Implementation.Quote>
    {
        /// <summary>
        ...
        Domain.Implementation.Quote? GetByQuoteNumber(string quoteNumber);
        ...
        IEnumerable<Domain.Implementation.Quote> GetByBeneficiaryId(int beneficiaryId);
        ...
        IEnumerable<Domain.Implementation.Quote> GetByCompanyId(int companyId);
