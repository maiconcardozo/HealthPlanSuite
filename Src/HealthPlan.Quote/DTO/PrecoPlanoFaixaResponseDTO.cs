...
{
    /// <summary>
    /// Data Transfer Object for PrecoPlanoFaixa response operations.
    /// Used for returning PrecoPlanoFaixa data to API consumers.
    /// </summary>
    public class PrecoPlanoFaixaResponseDTO
    {
        /// <summary>
        /// Gets or sets the unique identifier of the plan price range.
        /// </summary>
