...
{
    /// <summary>
    /// Controller for managing DescontoPromocional entities (Descontos Promocionais).
    ...
    public class DescontoPromocionalController : ControllerBase
    {
        ...
        /// </summary>
        /// <returns>
        /// Returns list of DescontoPromocional objects with their details and status on success, validation errors, unauthorized access, or internal server error.
        /// </returns>
        ...
        [HttpGet("")]
        [SwaggerResponse(StatusCodes.Status200OK, Type = typeof(IEnumerable<DescontoPromocionalResponseDTO>))]
        ...
        public IActionResult GetDescontoPromocional()
        {
            try
            {
                ...
                var descontoPromocionalResponse = descontoPromocional.Select(dp => CleanTemplateApplicationMapperInitializer.Mapper.Map<DescontoPromocionalResponseDTO>(dp));
        ...
        /// <returns>Returns DescontoPromocional matching the specified ID</returns>
        ...
        /// <response code="500">Internal server error</response>
        [HttpGet("{id}")]
        [SwaggerResponse(StatusCodes.Status200OK, Type = typeof(DescontoPromocionalResponseDTO))]
        [SwaggerResponse(StatusCodes.Status400BadRequest, Type = typeof(ProblemDetails))]
        [SwaggerResponse(StatusCodes.Status401Unauthorized, Type = typeof(ProblemDetails))]
        ...
        public IActionResult GetDescontoPromocional(int id)
        {
            try
            {
                ...
                var descontoPromocionalResponse = CleanTemplateApplicationMapperInitializer.Mapper.Map<DescontoPromocionalResponseDTO>(descontoPromocional);
                var successResponse = SuccessResponseExampleFactory.ForSuccess(descontoPromocionalResponse, ResourceAPI.RequestWasSuccessful, HttpContext.Request.Path);
                return Ok(successResponse);
            }
            catch (InvalidOperationException ex)
        ...
        /// <returns>Returns created DescontoPromocional on success, validation errors, unauthorized access, or internal server error</returns>
        ...
        /// <response code="500">Internal server error</response>
        [HttpPost("")]
        [SwaggerResponse(StatusCodes.Status201Created, Type = typeof(DescontoPromocionalResponseDTO))]
        [SwaggerResponse(StatusCodes.Status400BadRequest, Type = typeof(ProblemDetails))]
        [SwaggerResponse(StatusCodes.Status401Unauthorized, Type = typeof(ProblemDetails))]
        ...
        /// <returns>Returns updated DescontoPromocional on success, validation errors, unauthorized access, or internal server error</returns>
