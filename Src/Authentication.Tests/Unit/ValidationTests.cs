...
{
    [Fact]
    public void ValidationHelper_WithValidEntity_ShouldReturnNull()
    {
        // Arrange
        ...
        // Act
        var result = ValidationHelper.ValidateEntityAsync(entity, serviceProvider.Object, controller).Result;
    ...
    [Fact]
    public void ValidationHelper_WithInvalidEntity_ShouldReturnBadRequest()
    {
        // Arrange
    ...
    [Fact]
    public void ValidationHelper_WithNoValidator_ShouldReturnNull()
    {
        // Arrange
