...
{
    /// <summary>
    /// Data Transfer Object for CoparticipacaoProcedimento response operations.
    /// Used for returning CoparticipacaoProcedimento data to API consumers.
    /// </summary>
    public class CoparticipacaoProcedimentoResponseDTO
    {
        /// <summary>
        /// Gets or sets the unique identifier of the co-participation procedure.
        /// </summary>
