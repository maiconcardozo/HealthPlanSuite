...
- `Microsoft.AspNetCore.OpenApi`: 8.0.0 → 9.0.7
- `Microsoft.EntityFrameworkCore`: 8.0.0 → 9.0.7
- `Microsoft.EntityFrameworkCore.Abstractions`: 8.0.0 → 9.0.7
- `Microsoft.EntityFrameworkCore.Relational`: 8.0.0 → 9.0.7
- `Microsoft.EntityFrameworkCore.Tools`: 8.0.0 → 9.0.7
- `Pomelo.EntityFrameworkCore.MySql`: 8.0.0 → 9.0.0-preview.3.efcore.9.0.0
- `Swashbuckle.AspNetCore.*`: 6.5.0 → 9.0.3
