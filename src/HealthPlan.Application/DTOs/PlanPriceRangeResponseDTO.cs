...
{
    /// <summary>
    /// Data Transfer Object for PlanPriceRange response operations.
    /// Used for returning PlanPriceRange data to API consumers.
    /// </summary>
    public class PlanPriceRangeResponseDTO
    {
        /// <summary>
