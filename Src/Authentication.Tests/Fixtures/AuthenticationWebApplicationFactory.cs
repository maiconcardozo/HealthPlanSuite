...
public class AuthenticationWebApplicationFactory : WebApplicationFactory<AuthenticationTestStartup>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.UseStartup<AuthenticationTestStartup>();
        builder.UseEnvironment("Testing");
    }
}

// Minimal startup class for testing
public class AuthenticationTestStartup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseEndpoints(endpoints =>
        {
            ...
            endpoints.MapPost("/Authentication/AddAccount", async context =>
            {
