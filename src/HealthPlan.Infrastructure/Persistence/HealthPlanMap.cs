...
namespace HealthPlan.Infrastructure.Persistence
{
    ...
    /// </summary>
    internal class HealthPlanMap : IEntityTypeConfiguration<Domain.Entities.HealthPlan>
    {
        /// <summary>
        /// Configures the HealthPlan entity for Entity Framework.
        /// </summary>
        /// <param name="builder">Entity type builder for HealthPlan</param>
        public void Configure(EntityTypeBuilder<Domain.Entities.HealthPlan> builder)
        {
